...
public class SDLActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLayout = new RelativeLayout(this) {
            @Override
            public boolean onInterceptTocuhEvent(MotionEvent ev) {
                    ...
                    switch(action) {
                        ...
                        case MotionEvent.ACTION_MOVE:
                            for (i = 0; i < pointerCount; i++) {
                                ...
                                x = event.getX(i) / SDLActivity.getWidth();
                                y = event.getY(i) / SDLActivity.getHeight();
...
//            mScreenKeyboardShown = true;
    ...
    public static float getWidth() { return SDLSurface.mWidth; }
    
    public static float getHeight() { return SDLSurface.mHeight; }
}
